...
pairs_of_currency_metabolites_file = "./OA-pairs_of_currency_metabolites.csv"
special_currency_metabolites_file = "./OA-special_currency_metabolites.csv"
...
source_file = './TF-based Biosensors.csv'
